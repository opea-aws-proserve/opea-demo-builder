...
new OpeaChatQnAStack(app, 'OpeaChatQnAStack', eks.root.cluster.kubectlRole!, stackProps);
new OpeaGuardrailsStack(app, 'OpeaGuardrailsStack', eks.root.cluster.kubectlRole!, stackProps);
